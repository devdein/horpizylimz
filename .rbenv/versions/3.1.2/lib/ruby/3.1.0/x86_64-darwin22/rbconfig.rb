...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.1.0/x86_64-darwin22")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/local/Music/predominant-planet/horpizylimzfire/.rbenv/versions/3.1.2")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/local/Music/predominant-planet/horpizylimzfire/.rbenv/versions/3.1.2' '--with-openssl-dir=/usr/local/opt/openssl@3' '--enable-shared' '--with-readline-dir=/usr/local/opt/readline' '--with-libyaml-dir=/usr/local/opt/libyaml' '--with-gmp-dir=/usr/local/opt/gmp' 'CC=clang'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/local/Music/predominant-planet/horpizylimzfire/.rbenv/versions/3.1.2"
  ...
  CONFIG["GNU_LD"] = "no"
  CONFIG["GCC"] = "yes"
  CONFIG["EGREP"] = "/usr/local/bin/ggrep -E"
  CONFIG["GREP"] = "/usr/local/bin/ggrep"
  CONFIG["CPP"] = "$(CC) -E"
  ...
  CONFIG["target"] = "x86_64-apple-darwin22"
  CONFIG["host_os"] = "darwin22"
  CONFIG["host_vendor"] = "apple"
  CONFIG["host_cpu"] = "x86_64"
  CONFIG["host"] = "x86_64-apple-darwin22"
  CONFIG["build_os"] = "darwin22.3.0"
  CONFIG["build_vendor"] = "apple"
  CONFIG["build_cpu"] = "x86_64"
  CONFIG["build"] = "x86_64-apple-darwin22.3.0"
